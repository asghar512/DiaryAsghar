...
export const create = (
  ...
  try {
    ...
    if (!exUser) {
      return handleErrors(null, 'No Same User Found !!! Tyy It Again.');
    }
    ...
    return handleErrors(error, 'OHHH  OHHH There Is Some Error');
  }
};
...
export const addEntry = (
  ...
  try {
    ...
    return handleErrors(error, 'Couldnt not be save.');
  }
};
